...
public class gameScreen implements Screen {
  ...
  gameScreen(gotas game) {
      ...
      imagen= new Texture(Gdx.files.internal("descarga.jpg"));
      imagenGota = new Texture(Gdx.files.internal("tuberiaBuena.png"));
      imagenGota2 = new Texture(Gdx.files.internal("tuberiaBuena2.png"));
      imagenCubo = new Texture(Gdx.files.internal("bucket.png"));
      hola = new Texture(Gdx.files.internal("hola.jpg"));
      ...
      cubo = new Rectangle();
      cubo.x = 20; // centra el cubo horizontal
   ...
   public void render(float delta) {
      ...
      if(Gdx.input.isTouched()) {
       ...
       boolean upTouched = Gdx.input.isTouched() && Gdx.input.getY() < Gdx.graphics.getHeight() / 2;
        cubo.y -= 350 * Gdx.graphics.getDeltaTime();
      ...
      if(TimeUtils.nanoTime() - tiempoCaidaUltimaGota + 1000000 > 1000000000) creaGotaLluvia();
      ...
      while(iter.hasNext()) {
         ...
         gotaLluvia.x -= 200 * Gdx.graphics.getDeltaTime();
         if(segundo == false){
         ...
         if(gotaLluvia.overlaps(cubo)) {
            ...
            game.setScreen((Screen) new LooseScreen(game));
            dispose();
        }
      }
   }
